...
def main():
    ...
    metrics_df.to_csv(output_dir / "gru_rolling_metrics.csv", index=False)
    save_predictions(predictions_df, output_dir / "gru_test_predictions.csv")
    save_wis_by_state_date(predictions_df, output_dir / "gru_test_wis_by_state_date.csv")

    print("\nGRU rolling training completed")
